package ru.netology.neworknetology.screens.main.tabs.events.editEvent
...
import ru.netology.neworknetology.databinding.FragmentEditEventBinding
import ru.netology.neworknetology.model.enums.AttachmentType
import ru.netology.neworknetology.screens.main.tabs.events.createEvent.BottomSheetNewEvent
import ru.netology.neworknetology.screens.main.tabs.events.createEvent.ChangeEventViewModel
...
class EditEventFragment : Fragment(R.layout.fragment_edit_event)  {
    ...
    override fun onCreateView(
        ...
        binding.editText.setText(editedEvent?.content)
    ...
    private fun getEventArgument() {
       viewModel.setEditedEvent(args.currentEvent)
    }
